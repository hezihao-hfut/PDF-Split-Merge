...
class MergeTab(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._files: list[dict] = []  # [{"path": ..., "pages": int}, ...]
    ...
    def _add_files(self):
        ...
        for path in paths:
            try:
                ...
                continue
            self._files.append({"path": path, "pages": pages})
    ...
    def _refresh_list(self):
        ...
        self._stats_label.setText(f"共 {len(self._files)} 个文件，{total_pages} 页")
    ...
    def _on_rows_moved(self):
        ...
        for i in range(self._list_widget.count()):
            ...
            if widget:
                new_order.append({"path": widget.file_path, "pages": widget.page_count})
    ...
    def _merge(self):
        ...
        try:
            count = PdfEngine.merge(paths, output_path)
